...
def query_points_from_voxels(pred, gt, img_metas):
    ...
    vv[:, 0] = (vv[:, 0] + 0.5) * (
        img_metas["pc_range"][3] - img_metas["pc_range"][0]
    ) / img_metas["occ_size"][0] + img_metas["pc_range"][0]
    vv[:, 1] = (vv[:, 1] + 0.5) * (
        img_metas["pc_range"][4] - img_metas["pc_range"][1]
    ) / img_metas["occ_size"][1] + img_metas["pc_range"][1]
    vv[:, 2] = (vv[:, 2] + 0.5) * (
        img_metas["pc_range"][5] - img_metas["pc_range"][2]
    ) / img_metas["occ_size"][2] + img_metas["pc_range"][2]
